...
local mirrors = {
	...
	eye_measure = make_mirror({
		src = stretched_measure and { x = 177, y = 7902, w = 30, h = 580 } or { x = 162, y = 7902, w = 60, h = 580 },
...
local images = {
	...
	tall_overlay = make_image(tall_overlay_path, {
		dst = res_1440 and { x = 0, y = 0, w = 2560, h = 1440 } or { x = 0, y = 0, w = 1920, h = 1080 },
	}),
...
config.actions = {
	...
	[thin.key] = resize_helper(thin, function()
		resolutions.thin()
	end),
	[wide.key] = resize_helper(wide, function()
		resolutions.wide()
	end),
	[tall.key] = resize_helper(tall, function()
		resolutions.tall()
	end),
